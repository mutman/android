...
public class PrayerAdapter extends ArrayAdapter<Prayer> {
	...
	public PrayerAdapter(Context context, int textViewResourceId,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (v == null) {
			...
			v = vi.inflate(R.layout.mik_prayer_list_comp, null);
		}
		...
		if (prayer != null) {
			...
			if (prayer.isAlreadyRead()) {
				title.setTypeface(null, Typeface.NORMAL);
			} else {
				title.setTypeface(null, Typeface.BOLD);
			}
			ImageView categoryIcon = (ImageView) v.findViewById(R.id.categoryInPrayer);
